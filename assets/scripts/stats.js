...
// write a function to fetch the user's top songs from Spotify

// write a function to display the top tracks (implement according to HTML structure)

// create an event listener for the location input/search button

// call the function to fetch and display concerts on page load

// call the function to display the favorites on page load
